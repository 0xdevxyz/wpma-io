...
/**
 * POST /api/v1/rollback/notify
 * WordPress-Plugin meldet einen durchgeführten automatischen Rollback
 */
router.post('/notify', authenticateWordPressAPI, async (req, res) => {
    try {
...
/**
 * POST /api/v1/rollback/health-alert
 * WordPress-Plugin meldet gesundheitliche Probleme (z.B. nach Update)
 */
router.post('/health-alert', authenticateWordPressAPI, async (req, res) => {
    try {
