...
router.post('/:siteId/lighthouse', performanceController.runLighthouse.bind(performanceController));
router.get('/:siteId/lighthouse', performanceController.getLighthouse.bind(performanceController));
